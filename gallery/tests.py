...
class TestViews(TestCase):
    def setUp(self):
        self.categories = [Category.objects.create(name='Category 1'), Category.objects.create(name='Category 2')]
        self.image = Image.objects.create(title='Image 1', image=SimpleUploadedFile('test.jpg', b'file_content'), created_date='2022-01-01', age_limit=12)
